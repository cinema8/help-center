...
## <span className="inline-flex items-center gap-2 text-gray-900 dark:text-white"><ArrowDownTrayIcon className="w-5 h-5 text-blue-600" /> Download Player API</span>

[Download Cinema8 Player JavaScript API](https://static-01.cinema8.com/player/api/cinema8.player.api.min.js)
