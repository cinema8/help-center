...
description: "The Cinema8 Data API enables you to interact with Cinema8 Player via the API interface, allowing you to perform tasks such as managing projects and uploading media content. It uses the same interface for HTML5 versions of the player. Here's how you can get started:"
---
