...
description: "The Drawing element allows users to draw on their video. There are 6 different types of drawing available in the tool, with color options for the drawings that users can make."
---
