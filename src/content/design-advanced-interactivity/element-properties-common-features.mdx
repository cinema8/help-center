---
title: "Element Properties, Common Features"
...
<Callout type="info">
For conditional flows and logic-based branching, see the [Conditional Action Element guide](https://help.cinema8.com/conditional-action-element?hsLang=en-gb).
</Callout>
