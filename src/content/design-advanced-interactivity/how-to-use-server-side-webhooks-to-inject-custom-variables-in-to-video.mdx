...
description: "The Webhooks integration allows you to be automatically notified when certain events occur without the need to constantly poll the API. It also provides you with access to a new rule action, enabling you to set up a URL that will receive an HTTP request every time the rule is triggered."
---
