...
description: "You can add actions by dragging and dropping an Action widget to the timeline from the Elements panel. Assign a name to the widget and save it. Then, in the Properties panel, select an action from the Action list."
---
