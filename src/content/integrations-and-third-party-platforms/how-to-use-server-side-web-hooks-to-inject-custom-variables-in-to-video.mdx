...
description: "The Webhooks integration allows you to be automatically notified when certain events occur, without the need to constantly poll the API. Webhooks also provide access to a rule-based action that can set up a URL to receive an HTTP request whenever the rule is triggered."
---
