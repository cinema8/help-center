---
title: "Customizing Cinema8 Videos Using URL Parameters"
...
<Callout type="info">
You can also use URL parameters in **embedded iframes** and update them dynamically using the [Cinema8 JavaScript API](/advanced-tools-for-developers/javascript-api).
</Callout>
...
| `token`             | Pass user authentication token for tracking and analytics.                                             | `null`  | Learn more in [Authentication Tokens](/advanced-tools-for-developers/authentication-and-sso).    |
