...
Cinema8 Webhooks support nested object models. You can access deep values from structured data responses. [Learn more](/integrations-and-third-party-platforms/using-webhooks-in-interaction-design)
</Callout>
