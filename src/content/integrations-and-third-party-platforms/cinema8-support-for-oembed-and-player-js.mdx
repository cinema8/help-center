...
description: "oEmbed is an open format that enables embedding a URL's representation on third-party sites. With oEmbed, a website can display embedded content (like photos or videos) when a user posts a link to that resource without needing to parse the resource directly."
---
